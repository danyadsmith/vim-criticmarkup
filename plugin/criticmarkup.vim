augroup criticmarkup
    autocmd!
    autocmd Filetype pandoc,markdown,mkd,md,vimwiki,txt call criticmarkup#Init()
    autocmd Syntax pandoc,markdown,mkd,md,vimwiki,txt call criticmarkup#InjectHighlighting()
